  ...
  return (
    <form ref={formRef} action={async (fd) => {
      ...
      <div className="flex space-x-3">
        ...
        <input name="amount" type="number" step="0.01" placeholder="Amount" required className="flex-1 bg-[#222] border border-[#333] rounded-xl px-4 py-2.5 outline-none text-white text-sm focus:border-emerald-500 transition-colors" />
      </div>
      <div className="flex space-x-3">
        <input name="category" placeholder="Category (e.g. Food)" required className="flex-1 bg-[#222] border border-[#333] rounded-xl px-4 py-2.5 outline-none text-white text-sm focus:border-emerald-500 transition-colors" />
