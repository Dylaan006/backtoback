  ...
  return (
    <div className="bg-[#111] p-6 rounded-3xl border border-[#222]">
      <div className="flex justify-between items-end mb-6">
        <div>
          <p className="text-sm text-gray-400 font-medium uppercase tracking-wider mb-1">Consumido</p>
          <p className="text-4xl font-bold text-white">{consumed} <span className="text-sm font-normal text-gray-500">kcal</span></p>
        </div>
        <div className="text-right">
          <p className="text-sm text-gray-400 font-medium uppercase tracking-wider mb-1">Restante</p>
      ...
      <form action={updateGoal} className="flex items-center justify-between pt-5 border-t border-[#222]">
        <label className="text-sm font-medium text-gray-300">Meta Diaria</label>
        <div className="flex space-x-2">
          ...
          <button className="bg-[#222] text-gray-300 px-4 py-1.5 rounded-lg text-sm font-medium hover:bg-[#333] transition-colors">Guardar</button>
        </div>
      </form>
    </div>
  )
